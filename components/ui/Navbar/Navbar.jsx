                ...
                <div className="custom-screen items-center md:flex">
                    ...
                    <div className={`flex-1 items-center mt-8 text-gray-300 md:font-medium md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                        ...
                        <div className="gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
                            ...
                            <NavLink href="#pricing" className="flex items-center justify-center gap-x-0 ring-1 ring-purple-500 ring-opacity-50 hover:text-purple-500 hover:ring-opacity-100 hover:gap-x-2 py-2 px-5 text-gray-300 font-medium bg-gray-800 duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex">
                                Start Now 
